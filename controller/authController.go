...
func (ac *AuthController) Login(c *gin.Context) {
	...
	c.SetCookie("access-token", accessToken, 10, "/", "localhost:8080", false, true)
	// 여기는 리프레시토큰을 넣어줘야지
	// c.SetCookie("refresh-token", refreshToken, 60*60*24*30, "/", "localhost:8080", false, true)
	c.SetCookie("refresh-token", refreshToken, 30, "/", "localhost:8080", false, true)
...
func (ac *AuthController) VerifyToken(c *gin.Context){
	...
	c.SetCookie("access-token", newAccessToken, 10, "/", "localhost:8080", false, true)
